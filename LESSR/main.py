...
if args.valid_split is not None:
    ...
    valid_sessions = train_sessions[-num_valid:]
...
model = LESSR(num_items, args.embedding_dim, args.num_layers, feat_drop=args.feat_drop, logit_type=args.logit_type, scale=args.scale)
