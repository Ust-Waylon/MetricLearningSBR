...
class RAIN(Module):
    def __init__(self, adjacency, adjacency_a, adjacency_1, ad1r, ad1c, n_node, lr, layers, lambda1, lambda2, dataset, logit_type, scale, emb_size=100, batch_size=100):
    ...
    def forward(self, session_item, session_len, reversed_sess_item, mask, epoch, tar, train):
        ...
        if self.logit_type == 'dot':
            ...
            scores_item = - torch.cdist(sess_emb_i, item_embeddings_i, p=2) * self.scale
        else:
